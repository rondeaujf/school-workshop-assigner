...
printed `http://localhost:...` URL. Two presets are provided: one showing the
fairness/twins behavior, and one showing the exclusion `NEEDS_CONFIRMATION` →
...
demo/
  ...
  app.js             # Demo UI: presets, run/confirm flow, result rendering
